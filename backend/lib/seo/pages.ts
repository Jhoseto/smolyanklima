...
export const STATIC_PAGES: Record<string, SeoPage> = {
  ...
  '/catalog': {
    ...
    description: 'Пълен каталог климатици в Смолян — стенни, мулти-сплит, касетни, колонни. Филтри по BTU, марка, енергиен клас.',
  ...
  '/montaj-klimatik-smolyan': {
    ...
    description:
      'Професионален монтаж на климатик в Смолян и региона. Лицензиран екип, вакуумиране, гаранция. Безплатен оглед. Тел. 0888 58 58 16.',
