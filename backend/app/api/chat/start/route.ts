...
export async function POST(req: NextRequest) {
  ...
  // Email addresses entered in this public form are not ownership proof. Existing
  // visitors resume through their local session token; every start request creates
  // a fresh chat to avoid exposing or taking over another visitor's conversation.
