          ...
          >
            ...
            <div className="space-y-6 text-[1.05rem] text-gray-700 leading-[1.85]">
              <p>
                ...
                обаче как хората се връщат уморени от работа, как децата учат в стая, която лятото
                превръща в парна баня, и как зимата оставя влага и студ в старите панелни блокове.
                Реших, че мога да дам нещо повече от апарат — мога да дам{' '}
                <em className="text-gray-900 not-italic font-semibold">спокойствие у дома</em>.
              </p>
              <p>
                Първите години бяха трудни. Работех почти сам, носех апаратите по стълби, учех
              ...
              <p>
                ...
                Рудозем и Мадан. Всеки дом е различен: една стая с гледка към планината, друг —
                офис с десетки компютри. Научих се да слушам, преди да предложа решение.
              </p>
              <p>
                Днес „Смолян Клима“ е синоним на доверие. Продаваме водещи марки, но не
                „продаваме“ — консултираме. Монтираме бързо, но не бързаме там, където
              ...
              <p className="text-gray-900 font-medium border-l-4 border-[#FF4D00] pl-5 py-1">
                „Не съм строил фирма, която просто продава климатици. Изградих място, където хората
                знаят, че ще бъдат чути, обслужени и защитени — днес и след години.“
              </p>
              <p className="text-right text-gray-600 font-semibold pt-2">
                — Костадин Георгиев
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600">
              Всяко решение — от избора на модел до последната винт на конзолата — отразява тези
              принципи.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
