          ...
          >
            ...
            <div className="space-y-6 text-[1.05rem] text-gray-700 leading-[1.85]">
              ...
              <p>
                ...
                не се купува, а се печели с търпение и уважение към всеки клиент.
              </p>
              <p>
                ...
                Достигнахме нива на услугите до степен да можем да оборудваме големи сгради и офиси на големикорпоративни клиенти
                в цялата страна. 
                Всеки обект е различен: понякога е просто стая с гледка към планината, в други случаи е
                офис с десетки служители и специфично оборудване нуждащо от специализирана климатизация. 
