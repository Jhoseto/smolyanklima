...
const services = [
  {
    ...
    extraInfo: "Предлагаме пълната гама на Daikin, Mitsubishi Electric, Gree и Fujitsu. Осигуряваме гъвкави схеми на изплащане чрез TBI Bank, UniCredit, ДСК и JetCredit. Всеки закупен климатик идва с пълна техническа документация и официална гаранция от производителя.",
  ...
  },
  {
    ...
    extraInfo: "Имаме опит с ремонт на платки, подмяна на компресори и отстраняване на течове. Обслужваме най-популярните модели, което ни позволява да реагираме в рамките на няколко работни дни.",
