...
const PHONE = LEGAL_COMPANY.phone;
const ADDRESS = LEGAL_COMPANY.tradeAddress;
...
export class HandoffSkill {
  ...
  async execute(context: SkillContext): Promise<SkillResult> {
    ...
    try {
      ...
      return {
        success: false,
        response: `Съжалявам, имаше проблем при свързването. Моля, обадете се директно на ${PHONE}.`,
        confidence: 0,
      };
    }
  }
