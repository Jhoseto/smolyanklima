...
export const PAGE_SEO: Record<string, PageSeoConfig> = {
  ...
  catalog: {
    ...
    description:
      'Разгледайте пълния каталог климатици в Смолян — стенни, мулти-сплит, касетъчни. Филтри по BTU, марка и енергиен клас. Безплатна консултация и монтаж от лицензиран екип.',
  ...
  mount: {
    title: 'Цени за монтаж на климатик Смолян | Стандартен пакет и допълнителни услуги',
    description:
      'Официален ценоразпис за монтаж на климатици в Смолян — стандартен монтаж по BTU, таванен и мултисплит, допълнителни материали, оглед, профилактика и демонтаж. Цени с ДДС.',
    keywords: [
      ...REGION_KEYWORDS,
      'монтаж климатик цена',
      'ценоразпис монтаж климатик',
      'стандартен монтаж климатик',
      'монтаж климатик Смолян цена',
    ],
    canonicalPath: '/montaz',
  },
  contact: {
    title: 'Контакти — Смолян Клима | Магазин и монтаж климатици Смолян',
    description:
      'Свържете се със Смолян Клима — ул. „Наталия" 19, кв. Райково, Смолян. Тел. 0878 58 16 16. Безплатна консултация, оглед и оферта за климатик с монтаж.',
  ...
  about: {
    ...
    description:
      'Смолян Клима — семеен бизнес от 1990-те с над 10000 монтажа в Смолян, Рудозем, Мадан и Родопите. Оторизиран дилър, професионален монтаж и честна гаранция.',
